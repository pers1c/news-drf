...
class CommentSerializer(serializers.ModelSerializer):
    author_info = serializers.Serializer()
    replies_count = serializers.ReadOnlyField()
    is_reply = serializers.ReadOnlyField()

    class Meta:
        model = Comment
        fields = ('id', 'content', 'author', 'author_info', 'parent', 'is_active',
                  'replies_count', 'is_reply', 'created_at', 'updated_at')
    ...
    def get_author_info(self, obj):
        return {
            ...
            'avatar_url': obj.author.avatar_url if obj.author.avatar_url else None,
        }
